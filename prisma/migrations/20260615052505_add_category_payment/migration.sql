-- CreateEnum (IF NOT EXISTS o'rniga DO $$ ishlatamiz)
DO $$ BEGIN
...
-- AlterTable Order
ALTER TABLE "Order" ADD COLUMN IF NOT EXISTS "paymentMethod" "PaymentMethod" NOT NULL DEFAULT 'Cash';
...
VALUES ('default-category-id', 'Asosiy taomlar', 'Asosiy_taomlar')
ON CONFLICT ("name") DO NOTHING;

-- Mavjud productlarga default category
UPDATE "Product" SET "categoryId" = 'default-category-id' WHERE "categoryId" IS NULL;
